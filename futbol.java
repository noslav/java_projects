...
public class Main 
{
	public static void main(String[] args) 
	{
		...
		if(totalGoalsMad == totalGoalsBarc)
		{
		    ...
		    goalsAwayBarc = goalsAwayBarc *2; // 4 = 4
		    ...
		    System.out.println("F.C. Barcelona "+totalGoalsBarc);
		    System.out.println(" - Real Madrid "+totalGoalsMad);
		    
		    if(totalGoalsMad == totalGoalsBarc)
		    {
		        totalGoalsMad = totalGoalsMad+ penaltyMad;
		        totalGoalsBarc = totalGoalsBarc + penaltyBarc;
		        System.out.println("Teams are tied : Penalty kick out!");
		        System.out.println("F.C Barcelona "+penaltyBarc);
		        System.out.println("Real Madrid "+penaltyMad);
		        System.out.println("F.C. Barcelona "+totalGoalsBarc);
		        System.out.println("New Overall Result is ");
		        System.out.println(" - Real Madrid "+totalGoalsMad);
